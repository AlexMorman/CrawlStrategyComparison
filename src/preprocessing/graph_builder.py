...
class GraphBuilder:
    ...
    def build(self, seed):
        ...
        adjacency, depths = self._bfs(seed)
        ...
        self._save(seed, adjacency, inlink_counts, idf, document_lengths, avg_document_length, embeddings, depths)
    ...
    def _save(self, seed, adjacency, inlink_counts, idf, document_lengths, avg_document_length, embeddings, depths):
