...
class GraphBuilder:
    ...
    def build(self, seed):
        ...
        self._save(seed, adjacency, inlink_counts, idf, document_lengths, avg_document_length)

    # saves the sub-graph generated by bfs to outpur_dir/{seed}.json
    def _save(self, seed, adjacency, inlink_counts, idf, document_lengths, avg_document_length):
